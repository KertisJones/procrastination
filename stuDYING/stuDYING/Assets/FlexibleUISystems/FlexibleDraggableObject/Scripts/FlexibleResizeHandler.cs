        ...
        if (horizontalEdge != null && !disable)
        {
            ...
            { }
                //Target.SetInsetAndSizeFromParentEdge((RectTransform.Edge)horizontalEdge,
                 //   Target.position.x - Target.pivot.x,// * Target.rect.width,//-Screen.width + Target.position.x,// - (Target.position.x /100),//Target.position.x + Target.pivot.x * Target.rect.width, //- Target.pivot.x * Target.rect.width,//Screen.width,// + Target.position.x,// - Target.pivot.x, 
        ...
        if (verticalEdge != null && !disable)
        {
            if (verticalEdge == RectTransform.Edge.Top)
                Target.SetInsetAndSizeFromParentEdge((RectTransform.Edge)verticalEdge, 
                    Screen.height - Target.position.y,// - Target.pivot.y, 
