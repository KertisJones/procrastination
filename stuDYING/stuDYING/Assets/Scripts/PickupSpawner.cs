...
public class PickupSpawner : MonoBehaviour
{
	...
	private UnityTutorialPlayerHealth playerHealth;			// Reference to the PlayerHealth script.


	void Awake ()
	{
		// Setting up the reference.
		playerHealth = GameObject.FindGameObjectWithTag("Player").GetComponent<UnityTutorialPlayerHealth>();
	}
